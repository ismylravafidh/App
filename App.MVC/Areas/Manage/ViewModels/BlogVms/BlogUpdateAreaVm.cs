using App.Business.ViewModels.BaseVms;
...
namespace App.MVC.Areas.ViewModels.BlogVms
{
    public class BlogUpdateAreaVm : BaseEntityVm
    {
    ...
    public class BlogUpdateVmValidation : AbstractValidator<BlogUpdateAreaVm>
    {
